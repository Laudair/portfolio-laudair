...
const Contact = () => {
  return (
    <Box marginTop="42px" align="center"  >
      ...
      <Image boxSize="40px"src={LinkedinLogo} alt="Linkedin Logo" margin='0px' />
     ...
     <Link  style={{ color: '#999', textDecoration: 'none', margin:'8px'}}href="mailto:laudair.egevarth@hotmail.com" isExternal>
